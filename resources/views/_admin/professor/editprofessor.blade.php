                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_name" id="professor_name" value="{{$professor->professor_name}}" aria-describedby="helpId" placeholder="Enter Professor Name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_university" id="professor_university" value="{{$professor->professor_university}}" aria-describedby="helpId" placeholder="Enter Professor University">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" name="professor_email" id="professor_email" aria-describedby="helpId" value="{{$professor->professor_email}}" placeholder="Enter Professor Email">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_phone" id="professor_phone" aria-describedby="helpId" value="{{$professor->professor_phone}}" placeholder="Enter Professor Contact Number">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_researchinterest" id="professor_researchinterest" value="{{$professor->professor_researchinterest}}" aria-describedby="helpId" placeholder="Enter Professor Research Interest">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_disciplines" id="professor_disciplines" aria-describedby="helpId"  value="{{$professor->professor_disciplines}}"  placeholder="Enter Professor Discipline">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="professor_subdisciplines" id="professor_subdisciplines" aria-describedby="helpId" value="{{$professor->professor_subdisciplines}}" placeholder="Enter Professor sub-discipline">
